...
export const useBranches = (centerId?: string) => {
  ...
  const getBranchesFn = isAdminContext ? adminService.getBranches : centerService.getBranches;
...
export const useBranch = (branchId?: string) => {
  ...
  const getBranchFn = isAdminContext ? adminService.getBranch : centerService.getBranch;
